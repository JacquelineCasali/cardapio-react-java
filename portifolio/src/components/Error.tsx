...
export default function Error() {
  return (
      ...
      <div id="alert-border-2" className="flex items-center p-4 mb-4 text-red-900 border-t-4 border-red-400 bg-red-50 dark:text-red-500 dark:bg-gray-800 dark:border-red-800" role="alert">
